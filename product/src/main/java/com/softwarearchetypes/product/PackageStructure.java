 ...
 *
 * <p>It consists of two parts: 1. ProductSets - collections of available products (the "raw
 * material") 2. SelectionRules - rules defining valid selections (the "constraints")
 *
 * <p>Think of ProductSets as ingredients available in a kitchen, and SelectionRules as the recipe
 * rules: "use 1 meat", "add 2-3 vegetables", "if chicken then must add sauce".
 */
class PackageStructure {
    private final Map<String, ProductSet> productSets;
    private final List<SelectionRule> selectionRules;

    PackageStructure(Map<String, ProductSet> productSets, List<SelectionRule> selectionRules) {
    ...
    public String toString() {
        return "PackageStructure{sets=%d, rules=%d}"
                .formatted(productSets.size(), selectionRules.size());
    }
}

...
/**
 * Public API - queries for reading from ProductFacade and ProductCatalog. Queries represent read
 * operations (lookups, searches). All fields use simple types - no domain objects leak through the
 * API.
 */
public class ProductQueries {
    ...
    public record FindProductTypeCriteria(String productId // Will be parsed to ProductIdentifier
            ) {
    ...
    /**
     * Criteria to search catalog entries. All filters are optional - null/empty values are ignored.
     */
    public record SearchCatalogCriteria(
        ...
        /**
         * Creates criteria for product type features. Example: byFeatures(Map.of("storage",
         * Set.of("256GB", "512GB"))) finds all catalog entries where ProductType has feature
         * "storage" accepting "256GB" or "512GB".
         */
    ...
    public record FindCatalogEntryCriteria(String catalogEntryId // Will be parsed to CatalogEntryId
            ) {
    ...
    public record FindByMetadataCriteria(String key, String value) {

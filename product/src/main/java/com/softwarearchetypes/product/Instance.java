...
/**
 * Instance represents a specific instance/exemplar of a Product (either ProductType or
 * PackageType). While Product defines WHAT can be sold, Instance represents WHAT WAS actually
 * sold/created.
 *
 ...
 * Batch (group tracking for quality control) The tracking requirements are defined by the Product's
 * tracking strategy.
 */
interface Instance {

 ...
 *
 * <p>Format: 17 characters (uppercase letters and digits, excluding I, O, Q to avoid confusion)
 * Structure: - World Manufacturer Identifier (3 chars) - Vehicle Descriptor Section (6 chars) -
 * Check digit (1 char) - Model year (1 char) - Plant code (1 char) - Sequential number (6 chars)
 *
 * <p>Examples: "5YJ3E1EA1JF000001" (Tesla), "1HGBH41JXMN109186" (Honda)
 */
record VinSerialNumber(String value) implements SerialNumber {
    ...
    VinSerialNumber {
        ...
        checkArgument(
                normalized.matches("[A-HJ-NPR-Z0-9]{17}"),

...
/**
 * Container for all feature type definitions of a ProductType. Provides convenient access to
 * features by name and filtering by mandatory/optional status.
 */
                ...
                definitions.stream()
                        .collect(
                                Collectors.toUnmodifiableMap(
                                        def -> def.featureType().name(), def -> def));
    }

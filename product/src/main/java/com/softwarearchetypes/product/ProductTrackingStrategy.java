 ...
 *
 * <p>This directly addresses the fundamental question: "How do we distinguish between individual
 * items of this product type?"
 */
enum ProductTrackingStrategy {

    /** UNIQUE - One-of-a-kind product. Example: Hetfield's guitar, da Vinci's painting */
    UNIQUE,

    /**
     * INDIVIDUALLY_TRACKED - Each instance uniquely identified. Examples: iPhone, mortgage
     * contract, parcel tracking
     */
    INDIVIDUALLY_TRACKED,

    /**
     * BATCH_TRACKED - Tracked by production batch for quality control. Examples: milk bottles,
     * pharmaceuticals, food products
     */
    BATCH_TRACKED,

    /**
     * INDIVIDUALLY_AND_BATCH_TRACKED - Both individual and batch tracking. Examples: TVs,
     * smartphones (serial + batch for recalls)
     */
    INDIVIDUALLY_AND_BATCH_TRACKED,

    /**
     * IDENTICAL - Interchangeable items, may or may not create instances. Examples: screws (bulk),
     * rice bags (instance per bag), flour (bulk)
     */
    IDENTICAL;

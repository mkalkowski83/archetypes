...
/**
 * GTIN (Global Trade Item Number) - standard identifier for retail products. Supports multiple data
 * structures: - GTIN-8 (EAN-8): 8 digits - GTIN-12 (UPC-A): 12 digits - GTIN-13 (EAN-13): 13 digits
 * - GTIN-14: 14 digits
 *
 * <p>All include company prefix, item reference number, and check digit.
 */
record GtinProductIdentifier(String value) implements ProductIdentifier {
    ...
    GtinProductIdentifier {
        ...
        checkArgument(
                normalized.matches("\\d{8}|\\d{12}|\\d{13}|\\d{14}"),

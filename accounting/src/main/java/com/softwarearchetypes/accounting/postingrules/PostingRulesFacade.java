 ...
 *
 * <p>Note: This facade intentionally exposes domain objects (PostingRule, PostingRuleBuilder) and
 * interfaces (EligibilityCondition, PostingCalculator) to demonstrate the rich domain model
 * capabilities. In a production solution, we recommend transitioning to command-based API
 * (CreatePostingRule, UpdatePostingRule, etc.) to better encapsulate the domain model and provide
 * clearer boundaries.
 */

...
class EntryAllocationsTest {
    ...
    static final Instant TUESDAY_09_00 =
            LocalDateTime.of(2022, 2, 2, 9, 0).atZone(ZoneId.systemDefault()).toInstant();
    static final Instant TUESDAY_09_10 =
            LocalDateTime.of(2022, 2, 2, 9, 10).atZone(ZoneId.systemDefault()).toInstant();
    static final Instant TUESDAY_09_20 =
            LocalDateTime.of(2022, 2, 2, 9, 20).atZone(ZoneId.systemDefault()).toInstant();
    ...
    void should_filter_by_entry_type() {
        ...
        EntryAllocationFilter filter =
                EntryAllocationFilterBuilder.fifo(accountId)

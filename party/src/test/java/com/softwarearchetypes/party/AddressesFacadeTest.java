...
class AddressesFacadeTest {
    ...
    //     private AddressesFacade addressesFacade = new AddressesFacade(repository,
    // eventPublisher);
    //     private AddressesQueries addressesQueries = new AddressesQueries(repository);
    //
    //     private AddressesTestEventListener testEventListener = new
    // AddressesTestEventListener(eventPublisher);
    //
    //     @Test
    ...
    //
    //         //and
    //         GeoAddressDefined expectedEvent = (GeoAddressDefined)
    // address.toAddressDefinitionSucceededEvent();
    //
    //         //when
    //         addressesFacade.addOrUpdate(partyId, address);
    //
    ...
    //
    //         //and
    //         GeoAddressUpdated expectedEvent = (GeoAddressUpdated)
    // newAddress.toAddressUpdateSucceededEvent();
    //
    //         //when
    //         addressesFacade.addOrUpdate(partyId, newAddress);
    //
    ...
    //
    //         //and
    //         GeoAddressRemoved expectedEvent = (GeoAddressRemoved)
    // address.toAddressRemovalSucceededEvent();
    //
    //         //when
    //         addressesFacade.remove(partyId, address.id());
    //
    ...
    //     }
    //
    //     static class AddressesTestEventListener implements
    // InMemoryEventsPublisher.InMemoryEventObserver {
    //

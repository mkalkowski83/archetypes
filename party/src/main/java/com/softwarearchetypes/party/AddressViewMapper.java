...
class AddressViewMapper {
    ...
    static AddressView toView(Address address) {
        if (address instanceof GeoAddress geoAddress
                && address.addressDetails() instanceof GeoAddress.GeoAddressDetails details) {
        ...
        if (address instanceof EmailAddress emailAddress
                && address.addressDetails() instanceof EmailAddressDetails details) {
        ...
        if (address instanceof PhoneAddress phoneAddress
                && address.addressDetails() instanceof PhoneAddressDetails details) {
        ...
        if (address instanceof WebAddress webAddress
                && address.addressDetails() instanceof WebAddressDetails details) {

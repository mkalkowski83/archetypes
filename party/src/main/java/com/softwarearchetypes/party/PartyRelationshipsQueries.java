...
public class PartyRelationshipsQueries {
    ...
    public Optional<PartyRelationshipView> findBy(PartyRelationshipId partyId) {
        return repository.findBy(partyId).map(PartyRelationshipViewMapper::toView);
    }
    ...
    public List<PartyRelationshipView> findAllRelationsFrom(
            PartyId partyId, String relationshipName) {
    ...
    public List<PartyRelationshipView> findAllRelationsFrom(
            List<PartyId> partyIds, String relationshipName) {
        RelationshipName name = RelationshipName.of(relationshipName);
